        ...
        <div className="mx-auto max-w-5xl space-y-16">
          ...
          <FadeIn direction="up" duration={800}>
            <div className="space-y-6">
              ...
              <p className="leading-relaxed font-light text-refenti-charcoal md:text-lg">
                ...
                standards of governance, quality, and discipline in structurally
          ...
          <FadeIn direction="up" duration={800} delay={100}>
            <div className="space-y-6">
              ...
              <p className="leading-relaxed font-light text-refenti-charcoal md:text-lg">
                To operate as a disciplined, scalable real estate investment and
                development platform aligned with long-term capital and
          ...
          <FadeIn direction="up" duration={800}>
            <div className="space-y-8">
              ...
              <div className="space-y-6 leading-relaxed font-light text-refenti-charcoal md:text-lg">
                ...
                <p>
                  The platform prioritizes governance discipline, repeatability,
                  and institutional alignment over opportunistic or project-led
                  development. Projects are originated and developed within a
                  consistent framework designed to support scalability,
                  execution certainty, and long-term stewardship across diverse
                  assets and market cycles.
                </p>
              </div>
            </div>
          </FadeIn>

      ...
      <section className="border-y border-gray-100 px-8 py-16 md:px-12 md:py-20">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <FadeIn delay={100}>
              <div className="group relative bg-white p-8 shadow-2xl transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.35)]">
            ...
            <FadeIn delay={200}>
              <div className="group relative overflow-hidden bg-white p-8 shadow-2xl transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.35)]">
